function InvoiceController($scope) {
	...
	$scope.invoice = {
					  tax: 13.00, 
					  invoice_number: 10,
					  customer_info:  {name: "Mr. Manpreet Narang", web_link: "Tauxik Design Labs", address1: "49 Avalanche Cres.", address2: "Toronto, ON, Canada", postal: "L6P1L8"},
					  company_info:  {name: "Metaware Labs", web_link: "www.metawarelabs.com", address1: "49 Avalanche Cres.", address2: "Toronto, ON, Canada", postal: "L6P1L8"},
